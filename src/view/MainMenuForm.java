...
public class MainMenuForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        topPanel.setBorder(BorderFactory.createMatteBorder(0, 0, 3, 0, Color.black));
    ...
    private void quitButtonMouseClicked(java.awt.event.MouseEvent evt) {
         //System.out.println(this.productLabel.getText());         this.productLabel.setText("   Hei på deg!");     
    }
