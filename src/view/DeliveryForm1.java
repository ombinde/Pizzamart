...
public class DeliveryForm1 extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		leftPanel.setBorder(BorderFactory.createMatteBorder(0, 0, 0, 2,
				Color.darkGray));
		...
		leftPanelLayout.setHorizontalGroup(leftPanelLayout.createParallelGroup(
				...
				leftScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 411,
				Short.MAX_VALUE));
		leftPanelLayout.setVerticalGroup(leftPanelLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				leftScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 470,
				Short.MAX_VALUE));
	...
	private void updateLeftPanel() {
		...
		javax.swing.GroupLayout orderPanelLayout = new javax.swing.GroupLayout(
				orderPanel);
	...
	private ArrayList<JLabel> createOrderLabels() {
		...
		for (int i = 0; i < orders.size(); i++) {
			...
			if (order.getStatus().equals("Under levering")) {
				label = Labels.createTwoLineLabel(order.getDateAndTime()
	...
	private void setOrderPanelLayout(GroupLayout orderPanelLayout,
		...
		// Set horizontal axis
		javax.swing.GroupLayout.ParallelGroup tempHorizontalGroup = orderPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING);
		for (int i = 0; i < orderLabels.size(); i++) {
			tempHorizontalGroup.addComponent(orderLabels.get(i),
		...
		orderPanelLayout.setHorizontalGroup(orderPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						orderPanelLayout.createSequentialGroup()
								.addContainerGap()
								.addGroup(tempHorizontalGroup)));

		// Set vertical axis
		javax.swing.GroupLayout.SequentialGroup tempVerticalGroup = orderPanelLayout
				.createSequentialGroup();
		tempVerticalGroup.addContainerGap();
		for (int i = 0; i < orderLabels.size(); i++) {
			tempVerticalGroup.addComponent(orderLabels.get(i),
		...
		orderPanelLayout.setVerticalGroup(orderPanelLayout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				tempVerticalGroup));
