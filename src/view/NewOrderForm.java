...
public class NewOrderForm extends javax.swing.JFrame {
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	//Create the customer
    	Customer customer = controller.ManageOrder.addNewCustomer(firstName, lastName, address, zipCode, phoneNumber);
    	Order order = controller.ManageOrder.addNewOrder(customer);
