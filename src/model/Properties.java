...
public class Properties {
	...
	/**
	 * If the properties object is already initialized the object will be returned.
	 * Else it ill first construct it, and then return it.
	 * @return
	 */
	...
	/**
	 * Deletes the previous properties from the database, and inserts the new data.
	 * @param name
	 * @param address
	 * @param zipCode
	 * @param postalAddress
